...
public class UserController {
	...
	@ResponseBody
	public User getById(@RequestBody User user, HttpServletRequest request, HttpSession session ,HttpServletResponse response) throws IOException {

		User user1 = userService.getById(user);
		System.out.println("userprovider-2"+user);
